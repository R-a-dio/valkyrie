...
import radio_internal_manager "github.com/R-a-dio/valkyrie/rpc/manager"
...
type Bot interface {
	AnnounceSong(context.Context, *radio_internal_manager.Song) (*Null, error)
}
...
func (c *botProtobufClient) AnnounceSong(ctx context.Context, in *radio_internal_manager.Song) (*Null, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio.internal.ircbot")
...
func (c *botJSONClient) AnnounceSong(ctx context.Context, in *radio_internal_manager.Song) (*Null, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio.internal.ircbot")
	ctx = ctxsetters.WithServiceName(ctx, "Bot")
	ctx = ctxsetters.WithMethodName(ctx, "AnnounceSong")
	out := new(Null)
...
const BotPathPrefix = "/twirp/radio.internal.ircbot.Bot/"
...
func (s *botServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/radio.internal.ircbot.Bot/AnnounceSong":
...
func (s *botServer) serveAnnounceSongJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(radio_internal_manager.Song)
	...
	func() {
		...
		respContent, err = s.AnnounceSong(ctx, reqContent)
	}()
