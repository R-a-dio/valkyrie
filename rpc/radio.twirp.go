...
type Manager interface {
	...
	SetStreamInfo(context.Context, *StreamInfo) (*StreamInfo, error)
...
func (c *managerProtobufClient) SetStreamInfo(ctx context.Context, in *StreamInfo) (*StreamInfo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Manager")
	ctx = ctxsetters.WithMethodName(ctx, "SetStreamInfo")
	out := new(StreamInfo)
...
func (c *managerProtobufClient) SetStreamerConfig(ctx context.Context, in *StreamerConfig) (*StreamerConfig, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Manager")
	ctx = ctxsetters.WithMethodName(ctx, "SetStreamerConfig")
	out := new(StreamerConfig)
...
func (c *managerJSONClient) SetStreamInfo(ctx context.Context, in *StreamInfo) (*StreamInfo, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Manager")
	ctx = ctxsetters.WithMethodName(ctx, "SetStreamInfo")
	out := new(StreamInfo)
...
func (c *managerJSONClient) SetStreamerConfig(ctx context.Context, in *StreamerConfig) (*StreamerConfig, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Manager")
	ctx = ctxsetters.WithMethodName(ctx, "SetStreamerConfig")
	out := new(StreamerConfig)
...
func (s *managerServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/radio.Manager/SetUser":
		...
		return
	case "/twirp/radio.Manager/SetStreamInfo":
		s.serveSetStreamInfo(ctx, resp, req)
		return
...
func (s *managerServer) serveSetStreamInfo(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
	...
	switch strings.TrimSpace(strings.ToLower(header[:i])) {
	case "application/json":
		s.serveSetStreamInfoJSON(ctx, resp, req)
	case "application/protobuf":
		s.serveSetStreamInfoProtobuf(ctx, resp, req)
	default:
		msg := fmt.Sprintf("unexpected Content-Type: %q", req.Header.Get("Content-Type"))
		twerr := badRouteError(msg, req.Method, req.URL.Path)
		s.writeError(ctx, resp, twerr)
...
func (s *managerServer) serveSetStreamInfoJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "SetStreamInfo")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	func() {
		...
		respContent, err = s.Manager.SetStreamInfo(ctx, reqContent)
	}()
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *StreamInfo and nil error while calling SetStreamInfo. nil responses are not supported"))
		return
	}
...
func (s *managerServer) serveSetStreamInfoProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "SetStreamInfo")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *managerServer) serveSetStreamerConfigJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	// Call service method
	var respContent *StreamerConfig
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if r := recover(); r != nil {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *StreamerConfig and nil error while calling SetStreamerConfig. nil responses are not supported"))
		return
	}
...
type Streamer interface {
	...
	Queue(context.Context, *google_protobuf.Empty) (*QueueContent, error)
}
...
func (c *streamerProtobufClient) Queue(ctx context.Context, in *google_protobuf.Empty) (*QueueContent, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Streamer")
	ctx = ctxsetters.WithMethodName(ctx, "Queue")
	out := new(QueueContent)
	err := doProtobufRequest(ctx, c.client, c.urls[4], in, out)
	if err != nil {
		return nil, err
	}
...
func (c *streamerJSONClient) Queue(ctx context.Context, in *google_protobuf.Empty) (*QueueContent, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Streamer")
	ctx = ctxsetters.WithMethodName(ctx, "Queue")
	out := new(QueueContent)
...
func (s *streamerServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	case "/twirp/radio.Streamer/Stop":
		...
		return
	case "/twirp/radio.Streamer/RequestTrack":
...
func (s *streamerServer) serveQueueJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *QueueContent and nil error while calling Queue. nil responses are not supported"))
		return
	}
...
type Queue interface {
	AddRequest(context.Context, *Song) (*google_protobuf.Empty, error)
	...
	Entries(context.Context, *google_protobuf.Empty) (*QueueContent, error)
}
...
func (c *queueProtobufClient) AddRequest(ctx context.Context, in *Song) (*google_protobuf.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
...
func (c *queueProtobufClient) Entries(ctx context.Context, in *google_protobuf.Empty) (*QueueContent, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Queue")
...
func (c *queueJSONClient) AddRequest(ctx context.Context, in *Song) (*google_protobuf.Empty, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Queue")
	ctx = ctxsetters.WithMethodName(ctx, "AddRequest")
	out := new(google_protobuf.Empty)
...
func (c *queueJSONClient) Entries(ctx context.Context, in *google_protobuf.Empty) (*QueueContent, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Queue")
	ctx = ctxsetters.WithMethodName(ctx, "Entries")
	out := new(QueueContent)
...
func (s *queueServer) serveEntriesJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *QueueContent and nil error while calling Entries. nil responses are not supported"))
		return
	}
