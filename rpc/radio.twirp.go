...
type Manager interface {
	...
	SetSong(context.Context, *SongUpdate) (*SongUpdate, error)
...
func (c *managerProtobufClient) SetSong(ctx context.Context, in *SongUpdate) (*SongUpdate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Manager")
...
func (c *managerJSONClient) SetSong(ctx context.Context, in *SongUpdate) (*SongUpdate, error) {
	ctx = ctxsetters.WithPackageName(ctx, "radio")
	ctx = ctxsetters.WithServiceName(ctx, "Manager")
	ctx = ctxsetters.WithMethodName(ctx, "SetSong")
	out := new(SongUpdate)
...
func (s *managerServer) serveSetSongJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *SongUpdate and nil error while calling SetSong. nil responses are not supported"))
		return
	}
