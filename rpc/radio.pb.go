...
var file_radio_proto_rawDesc = []byte{
	...
	0x73, 0x79, 0x6e, 0x63, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xa6, 0x01, 0x0a, 0x10, 0x50, 0x72, 0x6f,
	...
	0x72, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xfe, 0x01, 0x0a,
	...
	0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x91, 0x01, 0x0a, 0x05, 0x50, 0x72, 0x6f, 0x78,
	...
	0x64, 0x61, 0x74, 0x61, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x30, 0x01, 0x32, 0xd8, 0x01, 0x0a, 0x09,
...
var file_radio_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_radio_proto_goTypes = []any{
	(ProxySourceEventType)(0),          // 0: radio.ProxySourceEventType
	(*Song)(nil),                       // 1: radio.Song
	(*ProxySourceEvent)(nil),           // 2: radio.ProxySourceEvent
	(*SourceID)(nil),                   // 3: radio.SourceID
	(*ProxyMetadataEvent)(nil),         // 4: radio.ProxyMetadataEvent
	(*StatusResponse)(nil),             // 5: radio.StatusResponse
	(*SongUpdate)(nil),                 // 6: radio.SongUpdate
	(*SongInfo)(nil),                   // 7: radio.SongInfo
	(*StreamerConfig)(nil),             // 8: radio.StreamerConfig
	(*UserUpdate)(nil),                 // 9: radio.UserUpdate
	(*User)(nil),                       // 10: radio.User
	(*DJ)(nil),                         // 11: radio.DJ
	(*Theme)(nil),                      // 12: radio.Theme
	(*ListenerInfo)(nil),               // 13: radio.ListenerInfo
	(*SongAnnouncement)(nil),           // 14: radio.SongAnnouncement
	(*SongRequestAnnouncement)(nil),    // 15: radio.SongRequestAnnouncement
	(*UserAnnouncement)(nil),           // 16: radio.UserAnnouncement
	(*StreamerResponse)(nil),           // 17: radio.StreamerResponse
	(*QueueID)(nil),                    // 18: radio.QueueID
	(*QueueEntry)(nil),                 // 19: radio.QueueEntry
	(*QueueInfo)(nil),                  // 20: radio.QueueInfo
	(*SongRequest)(nil),                // 21: radio.SongRequest
	(*RequestResponse)(nil),            // 22: radio.RequestResponse
	(*Error)(nil),                      // 23: radio.Error
	(*TrackerRemoveClientRequest)(nil), // 24: radio.TrackerRemoveClientRequest
	(*Listeners)(nil),                  // 25: radio.Listeners
	(*Listener)(nil),                   // 26: radio.Listener
...
var file_radio_proto_depIdxs = []int32{
	27, // 0: radio.Song.length:type_name -> google.protobuf.Duration
	28, // 1: radio.Song.last_played:type_name -> google.protobuf.Timestamp
	10, // 2: radio.Song.last_played_by:type_name -> radio.User
	28, // 3: radio.Song.last_requested:type_name -> google.protobuf.Timestamp
	27, // 4: radio.Song.request_delay:type_name -> google.protobuf.Duration
	28, // 5: radio.Song.sync_time:type_name -> google.protobuf.Timestamp
	10, // 6: radio.ProxySourceEvent.user:type_name -> radio.User
	0,  // 7: radio.ProxySourceEvent.event:type_name -> radio.ProxySourceEventType
	3,  // 8: radio.ProxySourceEvent.ID:type_name -> radio.SourceID
	10, // 9: radio.ProxyMetadataEvent.user:type_name -> radio.User
	10, // 10: radio.StatusResponse.user:type_name -> radio.User
	1,  // 11: radio.StatusResponse.song:type_name -> radio.Song
	7,  // 12: radio.StatusResponse.info:type_name -> radio.SongInfo
	13, // 13: radio.StatusResponse.listener_info:type_name -> radio.ListenerInfo
	8,  // 14: radio.StatusResponse.streamer_config:type_name -> radio.StreamerConfig
	10, // 15: radio.StatusResponse.stream_user:type_name -> radio.User
	1,  // 16: radio.SongUpdate.song:type_name -> radio.Song
	7,  // 17: radio.SongUpdate.info:type_name -> radio.SongInfo
	28, // 18: radio.SongInfo.start_time:type_name -> google.protobuf.Timestamp
	28, // 19: radio.SongInfo.end_time:type_name -> google.protobuf.Timestamp
	10, // 20: radio.UserUpdate.user:type_name -> radio.User
	28, // 21: radio.User.updated_at:type_name -> google.protobuf.Timestamp
	28, // 22: radio.User.deleted_at:type_name -> google.protobuf.Timestamp
	28, // 23: radio.User.created_at:type_name -> google.protobuf.Timestamp
	11, // 24: radio.User.dj:type_name -> radio.DJ
	12, // 25: radio.DJ.theme:type_name -> radio.Theme
	1,  // 26: radio.SongAnnouncement.song:type_name -> radio.Song
	7,  // 27: radio.SongAnnouncement.info:type_name -> radio.SongInfo
	13, // 28: radio.SongAnnouncement.listener_info:type_name -> radio.ListenerInfo
	1,  // 29: radio.SongRequestAnnouncement.song:type_name -> radio.Song
	10, // 30: radio.UserAnnouncement.user:type_name -> radio.User
	23, // 31: radio.StreamerResponse.error:type_name -> radio.Error
	1,  // 32: radio.QueueEntry.song:type_name -> radio.Song
	28, // 33: radio.QueueEntry.expected_start_time:type_name -> google.protobuf.Timestamp
	18, // 34: radio.QueueEntry.queue_id:type_name -> radio.QueueID
	19, // 35: radio.QueueInfo.entries:type_name -> radio.QueueEntry
	1,  // 36: radio.SongRequest.song:type_name -> radio.Song
	23, // 37: radio.RequestResponse.error:type_name -> radio.Error
	27, // 38: radio.Error.delay:type_name -> google.protobuf.Duration
	26, // 39: radio.Listeners.entries:type_name -> radio.Listener
	28, // 40: radio.Listener.start:type_name -> google.protobuf.Timestamp
	29, // 41: radio.Manager.CurrentStatus:input_type -> google.protobuf.Empty
	29, // 42: radio.Manager.UpdateFromStorage:input_type -> google.protobuf.Empty
	29, // 43: radio.Manager.CurrentSong:input_type -> google.protobuf.Empty
	6,  // 44: radio.Manager.UpdateSong:input_type -> radio.SongUpdate
	29, // 45: radio.Manager.CurrentThread:input_type -> google.protobuf.Empty
	30, // 46: radio.Manager.UpdateThread:input_type -> google.protobuf.StringValue
	29, // 47: radio.Manager.CurrentUser:input_type -> google.protobuf.Empty
	10, // 48: radio.Manager.UpdateUser:input_type -> radio.User
	29, // 49: radio.Manager.CurrentListenerCount:input_type -> google.protobuf.Empty
	31, // 50: radio.Manager.UpdateListenerCount:input_type -> google.protobuf.Int64Value
	29, // 51: radio.Proxy.SourceStream:input_type -> google.protobuf.Empty
	29, // 52: radio.Proxy.MetadataStream:input_type -> google.protobuf.Empty
	14, // 53: radio.Announcer.AnnounceSong:input_type -> radio.SongAnnouncement
	15, // 54: radio.Announcer.AnnounceRequest:input_type -> radio.SongRequestAnnouncement
	16, // 55: radio.Announcer.AnnounceUser:input_type -> radio.UserAnnouncement
	29, // 56: radio.Streamer.Start:input_type -> google.protobuf.Empty
	32, // 57: radio.Streamer.Stop:input_type -> google.protobuf.BoolValue
	21, // 58: radio.Streamer.RequestSong:input_type -> radio.SongRequest
	8,  // 59: radio.Streamer.SetConfig:input_type -> radio.StreamerConfig
	29, // 60: radio.Streamer.Queue:input_type -> google.protobuf.Empty
	19, // 61: radio.Queue.AddRequest:input_type -> radio.QueueEntry
	29, // 62: radio.Queue.ReserveNext:input_type -> google.protobuf.Empty
	29, // 63: radio.Queue.ResetReserved:input_type -> google.protobuf.Empty
	18, // 64: radio.Queue.Remove:input_type -> radio.QueueID
	29, // 65: radio.Queue.Entries:input_type -> google.protobuf.Empty
	29, // 66: radio.ListenerTracker.ListClients:input_type -> google.protobuf.Empty
	24, // 67: radio.ListenerTracker.RemoveClient:input_type -> radio.TrackerRemoveClientRequest
	5,  // 68: radio.Manager.CurrentStatus:output_type -> radio.StatusResponse
	29, // 69: radio.Manager.UpdateFromStorage:output_type -> google.protobuf.Empty
	6,  // 70: radio.Manager.CurrentSong:output_type -> radio.SongUpdate
	29, // 71: radio.Manager.UpdateSong:output_type -> google.protobuf.Empty
	30, // 72: radio.Manager.CurrentThread:output_type -> google.protobuf.StringValue
	29, // 73: radio.Manager.UpdateThread:output_type -> google.protobuf.Empty
	10, // 74: radio.Manager.CurrentUser:output_type -> radio.User
	29, // 75: radio.Manager.UpdateUser:output_type -> google.protobuf.Empty
	31, // 76: radio.Manager.CurrentListenerCount:output_type -> google.protobuf.Int64Value
	29, // 77: radio.Manager.UpdateListenerCount:output_type -> google.protobuf.Empty
	2,  // 78: radio.Proxy.SourceStream:output_type -> radio.ProxySourceEvent
	4,  // 79: radio.Proxy.MetadataStream:output_type -> radio.ProxyMetadataEvent
	29, // 80: radio.Announcer.AnnounceSong:output_type -> google.protobuf.Empty
	29, // 81: radio.Announcer.AnnounceRequest:output_type -> google.protobuf.Empty
	29, // 82: radio.Announcer.AnnounceUser:output_type -> google.protobuf.Empty
	17, // 83: radio.Streamer.Start:output_type -> radio.StreamerResponse
	17, // 84: radio.Streamer.Stop:output_type -> radio.StreamerResponse
	22, // 85: radio.Streamer.RequestSong:output_type -> radio.RequestResponse
	29, // 86: radio.Streamer.SetConfig:output_type -> google.protobuf.Empty
	20, // 87: radio.Streamer.Queue:output_type -> radio.QueueInfo
	29, // 88: radio.Queue.AddRequest:output_type -> google.protobuf.Empty
	19, // 89: radio.Queue.ReserveNext:output_type -> radio.QueueEntry
	29, // 90: radio.Queue.ResetReserved:output_type -> google.protobuf.Empty
	32, // 91: radio.Queue.Remove:output_type -> google.protobuf.BoolValue
	20, // 92: radio.Queue.Entries:output_type -> radio.QueueInfo
	25, // 93: radio.ListenerTracker.ListClients:output_type -> radio.Listeners
	29, // 94: radio.ListenerTracker.RemoveClient:output_type -> google.protobuf.Empty
