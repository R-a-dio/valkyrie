...
func (*Song) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{0}
}
...
func (*StatusResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{1}
}
...
func (*SongUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{2}
}
...
func (*SongInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{3}
}
...
func (*StreamerConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{4}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{5}
}
...
func (*ListenerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{6}
}
...
func (*SongAnnouncement) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{7}
}
...
func (*SongRequestAnnouncement) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{8}
}
...
func (*QueueEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{9}
}
...
func (*QueueInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{10}
}
...
func (*SongRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{11}
}
...
func (*RequestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_radio_2aa6189667037b02, []int{12}
}
...
func init() { proto.RegisterFile("rpc/radio.proto", fileDescriptor_radio_2aa6189667037b02) }

var fileDescriptor_radio_2aa6189667037b02 = []byte{
