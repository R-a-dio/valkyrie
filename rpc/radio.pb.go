...
var file_radio_proto_rawDesc = []byte{
	...
	0x65, 0x75, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0xe5, 0x01, 0x0a, 0x05, 0x51, 0x75, 0x65, 0x75,
	...
	0x6e, 0x74, 0x72, 0x79, 0x12, 0x34, 0x0a, 0x06, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x12, 0x0e,
...
var file_radio_proto_depIdxs = []int32{
	...
	14, // 55: radio.Queue.Remove:input_type -> radio.QueueID
	25, // 56: radio.Queue.Entries:input_type -> google.protobuf.Empty
	25, // 57: radio.ListenerTracker.ListClients:input_type -> google.protobuf.Empty
	20, // 58: radio.ListenerTracker.RemoveClient:input_type -> radio.TrackerRemoveClientRequest
	1,  // 59: radio.Manager.CurrentStatus:output_type -> radio.StatusResponse
	2,  // 60: radio.Manager.CurrentSong:output_type -> radio.SongUpdate
	25, // 61: radio.Manager.UpdateSong:output_type -> google.protobuf.Empty
	26, // 62: radio.Manager.CurrentThread:output_type -> google.protobuf.StringValue
	25, // 63: radio.Manager.UpdateThread:output_type -> google.protobuf.Empty
	6,  // 64: radio.Manager.CurrentUser:output_type -> radio.User
	25, // 65: radio.Manager.UpdateUser:output_type -> google.protobuf.Empty
	27, // 66: radio.Manager.CurrentListenerCount:output_type -> google.protobuf.Int64Value
	25, // 67: radio.Manager.UpdateListenerCount:output_type -> google.protobuf.Empty
	25, // 68: radio.Announcer.AnnounceSong:output_type -> google.protobuf.Empty
	25, // 69: radio.Announcer.AnnounceRequest:output_type -> google.protobuf.Empty
	25, // 70: radio.Announcer.AnnounceUser:output_type -> google.protobuf.Empty
	13, // 71: radio.Streamer.Start:output_type -> radio.StreamerResponse
	13, // 72: radio.Streamer.Stop:output_type -> radio.StreamerResponse
	18, // 73: radio.Streamer.RequestSong:output_type -> radio.RequestResponse
	25, // 74: radio.Streamer.SetConfig:output_type -> google.protobuf.Empty
	16, // 75: radio.Streamer.Queue:output_type -> radio.QueueInfo
	25, // 76: radio.Queue.AddRequest:output_type -> google.protobuf.Empty
	15, // 77: radio.Queue.ReserveNext:output_type -> radio.QueueEntry
	28, // 78: radio.Queue.Remove:output_type -> google.protobuf.BoolValue
	16, // 79: radio.Queue.Entries:output_type -> radio.QueueInfo
	21, // 80: radio.ListenerTracker.ListClients:output_type -> radio.Listeners
	25, // 81: radio.ListenerTracker.RemoveClient:output_type -> google.protobuf.Empty
