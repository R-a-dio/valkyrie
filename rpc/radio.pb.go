...
var file_radio_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	0x70, 0x52, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x32, 0xd3, 0x04, 0x0a, 0x07, 0x4d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x72, 0x12, 0x40, 0x0a, 0x0d, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x74, 0x53,
	...
	0x72, 0x61, 0x64, 0x69, 0x6f, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x12, 0x3a, 0x0a, 0x0b, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0xd8,
...
var file_radio_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_radio_proto_goTypes = []interface{}{
	...
	(*UserAnnouncement)(nil),           // 12: radio.UserAnnouncement
	(*StreamerResponse)(nil),           // 13: radio.StreamerResponse
	(*QueueID)(nil),                    // 14: radio.QueueID
	(*QueueEntry)(nil),                 // 15: radio.QueueEntry
	(*QueueInfo)(nil),                  // 16: radio.QueueInfo
	(*SongRequest)(nil),                // 17: radio.SongRequest
	(*RequestResponse)(nil),            // 18: radio.RequestResponse
	(*Error)(nil),                      // 19: radio.Error
	(*TrackerRemoveClientRequest)(nil), // 20: radio.TrackerRemoveClientRequest
	(*Listeners)(nil),                  // 21: radio.Listeners
	(*Listener)(nil),                   // 22: radio.Listener
...
var file_radio_proto_depIdxs = []int32{
	23, // 0: radio.Song.length:type_name -> google.protobuf.Duration
	24, // 1: radio.Song.last_played:type_name -> google.protobuf.Timestamp
	6,  // 2: radio.Song.last_played_by:type_name -> radio.User
	24, // 3: radio.Song.last_requested:type_name -> google.protobuf.Timestamp
	23, // 4: radio.Song.request_delay:type_name -> google.protobuf.Duration
	24, // 5: radio.Song.sync_time:type_name -> google.protobuf.Timestamp
	...
	24, // 13: radio.SongInfo.start_time:type_name -> google.protobuf.Timestamp
	24, // 14: radio.SongInfo.end_time:type_name -> google.protobuf.Timestamp
	6,  // 15: radio.UserUpdate.user:type_name -> radio.User
	24, // 16: radio.User.updated_at:type_name -> google.protobuf.Timestamp
	24, // 17: radio.User.deleted_at:type_name -> google.protobuf.Timestamp
	24, // 18: radio.User.created_at:type_name -> google.protobuf.Timestamp
	...
	6,  // 25: radio.UserAnnouncement.user:type_name -> radio.User
	19, // 26: radio.StreamerResponse.error:type_name -> radio.Error
	0,  // 27: radio.QueueEntry.song:type_name -> radio.Song
	24, // 28: radio.QueueEntry.expected_start_time:type_name -> google.protobuf.Timestamp
	14, // 29: radio.QueueEntry.queue_id:type_name -> radio.QueueID
	15, // 30: radio.QueueInfo.entries:type_name -> radio.QueueEntry
	0,  // 31: radio.SongRequest.song:type_name -> radio.Song
	19, // 32: radio.RequestResponse.error:type_name -> radio.Error
	23, // 33: radio.Error.delay:type_name -> google.protobuf.Duration
	22, // 34: radio.Listeners.entries:type_name -> radio.Listener
	24, // 35: radio.Listener.start:type_name -> google.protobuf.Timestamp
	25, // 36: radio.Manager.CurrentStatus:input_type -> google.protobuf.Empty
	25, // 37: radio.Manager.CurrentSong:input_type -> google.protobuf.Empty
	2,  // 38: radio.Manager.UpdateSong:input_type -> radio.SongUpdate
	25, // 39: radio.Manager.CurrentThread:input_type -> google.protobuf.Empty
	26, // 40: radio.Manager.UpdateThread:input_type -> google.protobuf.StringValue
	25, // 41: radio.Manager.CurrentUser:input_type -> google.protobuf.Empty
	6,  // 42: radio.Manager.UpdateUser:input_type -> radio.User
	25, // 43: radio.Manager.CurrentListenerCount:input_type -> google.protobuf.Empty
	27, // 44: radio.Manager.UpdateListenerCount:input_type -> google.protobuf.Int64Value
	10, // 45: radio.Announcer.AnnounceSong:input_type -> radio.SongAnnouncement
	11, // 46: radio.Announcer.AnnounceRequest:input_type -> radio.SongRequestAnnouncement
	12, // 47: radio.Announcer.AnnounceUser:input_type -> radio.UserAnnouncement
	25, // 48: radio.Streamer.Start:input_type -> google.protobuf.Empty
	28, // 49: radio.Streamer.Stop:input_type -> google.protobuf.BoolValue
	17, // 50: radio.Streamer.RequestSong:input_type -> radio.SongRequest
	4,  // 51: radio.Streamer.SetConfig:input_type -> radio.StreamerConfig
	25, // 52: radio.Streamer.Queue:input_type -> google.protobuf.Empty
	15, // 53: radio.Queue.AddRequest:input_type -> radio.QueueEntry
	25, // 54: radio.Queue.ReserveNext:input_type -> google.protobuf.Empty
	25, // 55: radio.Queue.ResetReserved:input_type -> google.protobuf.Empty
	14, // 56: radio.Queue.Remove:input_type -> radio.QueueID
	25, // 57: radio.Queue.Entries:input_type -> google.protobuf.Empty
	25, // 58: radio.ListenerTracker.ListClients:input_type -> google.protobuf.Empty
	20, // 59: radio.ListenerTracker.RemoveClient:input_type -> radio.TrackerRemoveClientRequest
	1,  // 60: radio.Manager.CurrentStatus:output_type -> radio.StatusResponse
	2,  // 61: radio.Manager.CurrentSong:output_type -> radio.SongUpdate
	25, // 62: radio.Manager.UpdateSong:output_type -> google.protobuf.Empty
	26, // 63: radio.Manager.CurrentThread:output_type -> google.protobuf.StringValue
	25, // 64: radio.Manager.UpdateThread:output_type -> google.protobuf.Empty
	6,  // 65: radio.Manager.CurrentUser:output_type -> radio.User
	25, // 66: radio.Manager.UpdateUser:output_type -> google.protobuf.Empty
	27, // 67: radio.Manager.CurrentListenerCount:output_type -> google.protobuf.Int64Value
	25, // 68: radio.Manager.UpdateListenerCount:output_type -> google.protobuf.Empty
	25, // 69: radio.Announcer.AnnounceSong:output_type -> google.protobuf.Empty
	25, // 70: radio.Announcer.AnnounceRequest:output_type -> google.protobuf.Empty
	25, // 71: radio.Announcer.AnnounceUser:output_type -> google.protobuf.Empty
	13, // 72: radio.Streamer.Start:output_type -> radio.StreamerResponse
	13, // 73: radio.Streamer.Stop:output_type -> radio.StreamerResponse
	18, // 74: radio.Streamer.RequestSong:output_type -> radio.RequestResponse
	25, // 75: radio.Streamer.SetConfig:output_type -> google.protobuf.Empty
	16, // 76: radio.Streamer.Queue:output_type -> radio.QueueInfo
	25, // 77: radio.Queue.AddRequest:output_type -> google.protobuf.Empty
	15, // 78: radio.Queue.ReserveNext:output_type -> radio.QueueEntry
	25, // 79: radio.Queue.ResetReserved:output_type -> google.protobuf.Empty
	28, // 80: radio.Queue.Remove:output_type -> google.protobuf.BoolValue
	16, // 81: radio.Queue.Entries:output_type -> radio.QueueInfo
	21, // 82: radio.ListenerTracker.ListClients:output_type -> radio.Listeners
	25, // 83: radio.ListenerTracker.RemoveClient:output_type -> google.protobuf.Empty
...
func file_radio_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_radio_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
