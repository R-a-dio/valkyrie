...
var pendingTests = []pendingTest{
	...
	{
		Name:                "Accept Error RemoveSubmission",
		Status:              radio.SubmissionAccepted,
		ShouldRollback:      true,
		TxFunc:              mocks.RollbackTx,
	...
	{
		Name:                 "Accept Error InsertPostPending",
		Status:               radio.SubmissionAccepted,
		ShouldRollback:       true,
		TxFunc:               mocks.RollbackTx,
	...
	{
		Name:             "Accept Error GetSubmission",
		Status:           radio.SubmissionAccepted,
		ShouldRollback:   true,
		ExpectedForm:     &PendingForm{},
	...
	{
		Name:           "Decline Error RemoveSubmission",
		ShouldRollback: true,
